...
<script>
    layui.use(['layer', 'table'], function(){
        ...
        table.render({
            elem: '#test'
            ,url:'/selectServlet?type=student'
            ,height: '960'
            ,toolbar: '#toolbarDemo'
            ,title: '学生信息表'
            ,cols: [[
        ...
        table.on('tool(test)', function(obj){
            ...
            switch (obj.event) {
                case 'del':
                    layer.confirm('真的要删除学生'+data.name+'吗？', function(){
                        window.location.href="/deleteServlet?type=student&getday="+getday+"&time="+now+"&admin="+window.parent.id+"-"+window.parent.name+"&id="+data.id;
                    });
                    break;
                case 'edit':
                    layer.open({
        ...
        $('#layuisearch .layui-btn').on('click', function(){
            ...
            table.reload('testReload', {
                url: '/selectServlet?type=student&value='+inputVal+''
                ,where: {
                    id : inputVal
                }
                ,page: {
