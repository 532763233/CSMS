...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container" id="layerDemo">
        <button class="layui-btn " lay-event="delete" >批量退课</button>
    </div>
</script>
...
<script>
    layui.use(['layer', 'table','laydate','form'], function(){
        ...
        table.render({
            elem: '#test'
            ,url:'/selectServlet?type=sc&search=s_id&value='+window.parent.id+''
            ,height: '960'
            ,toolbar: '#toolbarDemo'
            ,title: '选课信息表'
            ,cols: [[
                        ...
                        ,success: function(){
                            ...
                            $('#submit').on('click', function() {
                                ...
                                for(var i=0;i<data.length;i++){
                                    ...
                                    drr.push(data[i].s_id);
                                    err.push(data[i].s_name);
                                }
                                var newUrl="/addapply?ret=ed&mold=申请不学习这门课程&c_name=" + arr.toString() + "&time_start=" + brr.toString() + "&time_end=" + crr.toString() + "&t_id=" + drr.toString() + "&t_name="+err.toString()+"";
